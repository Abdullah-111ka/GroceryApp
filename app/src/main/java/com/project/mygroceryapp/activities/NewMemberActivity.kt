...
import com.project.mygroceryapp.utils.DateParser
import com.project.mygroceryapp.R
import com.project.mygroceryapp.databinding.ActivityNewMemberBinding
import java.util.*
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnSubmitNewMember.setOnClickListener {
            ...
            if (isValidCustomerInfo()) {
                ...
                val tvLastname = customerInfoDialog.findViewById<TextView>(R.id.tv_lastname_new)
                val tvFirstname = customerInfoDialog.findViewById<TextView>(R.id.tv_firstname_new)
                val tvMiddlename = customerInfoDialog.findViewById<TextView>(R.id.tv_middlename_new)
                val tvHouseSt = customerInfoDialog.findViewById<TextView>(R.id.tv_housest_new)
                val tvPhaseZone = customerInfoDialog.findViewById<TextView>(R.id.tv_phasezone_new)
                val tvCity = customerInfoDialog.findViewById<TextView>(R.id.tv_city_new)
                val tvContact = customerInfoDialog.findViewById<TextView>(R.id.tv_contact_new)
                val tvBirthday = customerInfoDialog.findViewById<TextView>(R.id.tv_birthday_new)
                ...
                val btnOrder = customerInfoDialog.findViewById<Button>(R.id.btn_order)
...
//                        it.putExtra("CONTACT", tvContact.text.toString())
    ...
    private fun setDate() {
        ...
        val datePickerDialog = DatePickerDialog(this, DatePickerDialog.OnDateSetListener { _, year, monthOfYear, dayOfMonth ->
            ...
            binding.etNewMemberBirthday.setText(
                DateParser.parse(
                "MM/dd/yyyy",
                "MMM dd yyyy",
                finalDate!!))
