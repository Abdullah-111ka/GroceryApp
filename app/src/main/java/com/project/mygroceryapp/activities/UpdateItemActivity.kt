...
import com.project.mygroceryapp.databinding.ActivityUpdateItemBinding
...
class UpdateItemActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val autoCompleteText = searchView.findViewById<AutoCompleteTextView>(androidx.constraintlayout.widget.R.id.search_src_text)
        ...
        autoCompleteText.setOnItemClickListener { _, _, position, _ ->
            ...
            val hiddenTv = disappearingText.findViewById<TextView>(R.id.tv_side_nav_update_product_found)
