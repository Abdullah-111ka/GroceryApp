...
import com.project.mygroceryapp.databinding.ActivityDeleteBinding
...
class DeleteItemActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val autoCompleteTextView = searchView.findViewById<AutoCompleteTextView>(androidx.transition.R.id.search_src_text)
